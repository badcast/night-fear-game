...
namespace RoninEngine
{
	...
	Scene::~Scene()
	{
		...
		if (_firstRunScripts)
		{
			deallocate_variable(_firstRunScripts);
		}
		if (_realtimeScripts)
		{
			deallocate_variable(_realtimeScripts);
		}
		if (_destructions)
		{
			deallocate_variable(_destructions);
		}
