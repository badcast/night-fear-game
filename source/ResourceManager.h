...
public:
  ...
  [[deprecate]] static list<SDL_Surface *> *
  LoadSurfaces(const string &packName);
  [[deprecate]] static list<Runtime::Texture *> *
  LoadTextures(const string &packName, bool autoUnload = true);
  ...
  static T* gc_push(T*& lvalue_pointer, Args &&... arguments){
  ...
  template <typename T> static bool valid_type();
  ...
  template <typename T, typename X = std::enable_if_t<
                            std::is_base_of<RoninEngine::Scene, T>::value, T *>>
  ...
  static int gc_resource_sdl_surface(const string &resourceName,
                                     FolderKind folderKind,
                                     SDL_Surface **sdlsurfacePtr);

  static SDL_Surface *gc_resource_sdl_surface(const string &resourceName,
                                              FolderKind folderKind) {
    SDL_Surface *sdlsurf;
  ...
  static int gc_alloc_sdl_surface(SDL_Surface **sdlsurfacePtr, const int &w,
                                  const int &h);
  ...
  static int gc_alloc_sdl_texture(SDL_Texture **sdltexturePtr, const int &w,
                                  const int &h);
  ...
  static int gc_alloc_sdl_texture(SDL_Texture **sdltexturePtr,
                                  SDL_Surface *from);
  ...
  static int gc_alloc_texture_from(Texture **texturePtr,
  ...
  static int gc_alloc_sprite_with(Sprite **spritePtr, Texture *texture,
                                  const Rect_t &rect,
                                  const Vec2 &center = Vec2::half);

  static int gc_alloc_cursor(SDL_Cursor **cursorPtr, SDL_Surface *surface,
