...
void Transform::LookAtLerp(Transform* target, float t) { LookAtLerp(target->point, t); }

void Transform::LookAt(Transform* target, Vec2 axis) { LookAt(target->point, axis); }
...
Vec2 Transform::localPosition() {
    if (this->_parent != nullptr) return this->_parent->point - point;
    return point;
}
void Transform::localPosition(const Vec2& value) { point = (this->_parent != nullptr) ? _parent->point + value : value; }
